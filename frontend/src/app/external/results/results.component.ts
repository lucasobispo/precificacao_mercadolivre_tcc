...
export class ResultsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private SearchService: SearchService, private router: Router, private NotificationServe: NotificationService) {
    ...
    if (this.router.getCurrentNavigation()) {
      ...
      //this.titulo = "Xiaomi Redmi Note 9 3GB 64GB 2019 DUAL Usado";
      this.titulo = this.phone.Marca +" "+ this.phone.marca_renomeado_upper +" "+ this.phone.Linha +" "+
                    this.phone.memoria_ram +" "+ this.phone.memoria_interna +" "+ this.phone.ano_lancamento +" "+ this.phone.quantidade_sims +" "+ this.phone.condition;
    }
    else {
  ...
  onSubmit(): void {
    ...
    this.SearchService.search(this.phone)
      .subscribe(ret => {
        ...
        //https://produto.mercadolivre.com.br/MLB-1797743477-xiaomi-redmi-note-9-dual-sim-64-gb-midnight-grey-3-gb-ram-_JM?searchVariation=
        //76297491154#searchVariation=76297491154&position=3&search_layout=stack&type=item&tracking_id=54153088-bdfa-4e61-a9f9-f4d7b3388163
        //this.titulo = "Xiaomi Redmi Note 9 3GB 64GB 2019 DUAL Usado"
        this.titulo = this.phone.Marca +" "+ this.phone.marca_renomeado_upper +" "+ this.phone.Linha +" "+
                    this.phone.memoria_ram +" "+ this.phone.memoria_interna +" "+ this.phone.ano_lancamento +" "+ this.phone.quantidade_sims +" "+ this.phone.condition
        // this.titulo = {{phone.Marca}} {{phone.marca_renomeado_upper}} {{phone.Linha}} {{phone.memoria_ram}} {{phone.memoria_interna}} {{phone.ano_lancamento}}
        // {{phone.quantidade_sims}} {{phone.condition}};
      }, error => {
